...
const demoClients = [
  {
    ...
    pets: [{ id: 'p1', name: 'Buster', type: 'Dog', feedingTime: 'After morning visit' }, { id: 'p2', name: 'Luna', type: 'Cat' }],
    address: 'BGC, Taguig',
    gcash: '09170000001',
    keyStatus: 'received',
  },
  {
    ...
    pets: [{ id: 'p3', name: 'Fluffy', type: 'Cat', notes: 'Give extra play time before leaving.' }],
    address: 'Makati City',
    gcash: '09170000002',
    keyStatus: 'pending',
  },
  {
    ...
    pets: [{ id: 'p4', name: 'Max', type: 'Dog' }, { id: 'p5', name: 'Bella', type: 'Dog' }],
    address: 'Quezon City',
    keyStatus: 'none',
  },
];
...
const demoBookings = [
  {
    ...
    notes: 'Buster eats after the visit. Check Luna water bowl before leaving.',
    daySchedule: [{
      date: todayLocalStr(),
      service: 'Basic Visit|200',
      time: '10:00 AM',
  ...
  },
  {
    ...
    finalTotal: 250,
    discount: { mode: 'none', value: 0, label: '', appliesTo: 'service' },
    notes: 'Fluffy likes playtime first, then food.',
    daySchedule: [{
      date: todayLocalStr(),
      service: 'Play & Visit|250',
      time: '2:00 PM',
